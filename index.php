          ...
          <form action="booking.php" method="POST">
            ...
            <div class="form-row ">
              <div class="form-group col-lg-4">
                ...
                <input type="text" name="patient_name" class="form-control" id="inputPatientName" placeholder="" required>
              </div>
              <div class="form-group col-lg-4">
              ...
              <div class="form-group col-lg-4">
                ...
                <select name="department_name" class="form-control wide" id="inputDepartmentName">
                  <?php foreach($treatments as $treatment): ?>
                    <option value="<?= $treatment['title'] ?>"><?= $treatment['title'] ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
            </div>
            <div class="form-row ">
              <div class="form-group col-lg-4">
                ...
                <input type="number" name="phone" class="form-control" id="inputPhone" placeholder="XXXXXXXXXX" required>
              </div>
              <div class="form-group col-lg-4">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="detail-box">
            ...
            <p>
              Mico Hospital is a leading healthcare provider dedicated to delivering patient-centered care. With years of medical excellence, our modern facility offers comprehensive services ranging from emergency care to specialized treatments. Your health is our top priority.
            </p>
            <a href="">
              Read More
            </a>
